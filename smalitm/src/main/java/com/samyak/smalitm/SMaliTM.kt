...
import com.samyak.smalitm.adapters.TokenAdapter
import com.samyak.smalitm.callbacks.EventListener
import com.samyak.smalitm.callbacks.MessageFetchedCallback
import com.samyak.smalitm.callbacks.MessageListener
import com.samyak.smalitm.callbacks.WorkCallback
import com.samyak.smalitm.exceptions.AccountNotFoundException
import com.samyak.smalitm.exceptions.MessageFetchException
import com.samyak.smalitm.io.IO
import com.samyak.smalitm.io.IOCallback
...
class SMaliTM(
     ...
     */
    fun init() {
        com.samyak.smalitm.util.Domains.updateDomains()
    }
