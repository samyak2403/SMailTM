                ...
                pom {
                    ...
                    developers {
                        developer {
                            id.set("samyak2403")
                            name.set("Samyak")
                            email.set("samyakkamble6659@gmail.com")
                        }
                    }
                    
                    scm {
                        connection.set("scm:git:git://github.com/samyak2403/SMailTM.git")
                        developerConnection.set("scm:git:ssh://github.com/samyak2403/SMailTM.git")
                        url.set("https://github.com/samyak2403/SMailTM")
                    }
                }
            }
